...
export class ForoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    resp1.text = 'Holaa alguien me podria ayudar con este logaritmo :  log4 2 = 0,5 y log4 3 = 0,7924 calcula log4 6 ?? ';
    ...
    r1.text = 'Holaa, si solo debes resolverlo asi log4 6 = log4 (2 * 3) = log4 2 + log4 3 = 0,5 + 0,7924 = 1,2924 ';
    ...
    resp2.text = 'Hola, que tal? alguno podria explicarme caclular el siguiente ejercico :"Sabiendo que log4 6 = 1,2924 y log4 3 = 0,7925 calcula log3 6" ';
